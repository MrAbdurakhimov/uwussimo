...
export const open =
  (processes: Processes, updateProcesses: Dispatch<ProcessAction>) =>
  (
    appFile: AppFile,
    previousState: ProcessState,
...
export const taskbarElement =
  (updateProcesses: Dispatch<ProcessAction>) =>
  (id: string, element: HTMLButtonElement): void => {
...
export const title =
  (updateProcesses: Dispatch<ProcessAction>) =>
  (id: string, name = ''): void =>
    updateProcesses({ updates: { name }, id });
